"""Dependency providers for JiraFetcher with context awareness.

Provides get_jira_fetcher for use in tool functions.
...
# Confluence removed - Jira only
async def get_confluence_fetcher(ctx: Context) -> None:
    """Stub function - Confluence has been removed from this installation."""
    raise NotImplementedError("Confluence functionality has been removed. This is a Jira-only installation.")
